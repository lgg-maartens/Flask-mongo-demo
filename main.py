...
@web_site.route('/')
def index():
  client = pymongo.MongoClient("mongodb+srv://lgg:Xs28treBRa4HqRr@cluster0.stdll.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
  mydb = client.highscores

  return render_template('index.html',scores = mydb.scores.find())
